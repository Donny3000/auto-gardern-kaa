...
typedef struct {
    kaa_union_t * soil_temperature;
    kaa_union_t * soil_volmetric_water_content;
    kaa_union_t * ambient_air_temp;
    kaa_union_t * ambient_air_humidity;
    kaa_union_t * ambient_luminosity;
