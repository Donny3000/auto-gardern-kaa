...
# ifndef KAA_CONFIGURATION_UNION_INT_OR_NULL_H_
# define KAA_CONFIGURATION_UNION_INT_OR_NULL_H_

# define KAA_CONFIGURATION_UNION_INT_OR_NULL_BRANCH_0    0
# define KAA_CONFIGURATION_UNION_INT_OR_NULL_BRANCH_1    1
...
# endif // KAA_CONFIGURATION_UNION_INT_OR_NULL_H_



# ifndef KAA_CONFIGURATION_UNION_BOOLEAN_OR_NULL_H_
# define KAA_CONFIGURATION_UNION_BOOLEAN_OR_NULL_H_

# define KAA_CONFIGURATION_UNION_BOOLEAN_OR_NULL_BRANCH_0    0
# define KAA_CONFIGURATION_UNION_BOOLEAN_OR_NULL_BRANCH_1    1
...
# endif // KAA_CONFIGURATION_UNION_BOOLEAN_OR_NULL_H_



typedef struct {
    kaa_union_t * sample_period;
    kaa_union_t * turn_water_on;
